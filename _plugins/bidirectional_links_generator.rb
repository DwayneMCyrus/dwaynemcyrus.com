...
# The generator creates a _includes/docs_graph.json file with nodes and edges that can be used for visualizing the bidirectional links on the frontend if needed.
# Chat GPT update: 
# frozen_string_literal: true
